...
(function ($, undefined) {
   ...
   */
     ...
     * main options have to be defined in order for the tokenizer to work.
     *
    ...
    AbstractSelect2 = clazz(Object, {
        ...
        init: function (opts) {
            ...
            if ($.isFunction(this.opts.initSelection)) {
                ...
                // we monitor the change event on the element and trigger it, allowing for main way synchronization
                this.monitorSource();
            }
