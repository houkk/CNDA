...
var str="<div class='in_navigation isDown'> " +
    ...
    "<li><a href='tables/userprofile.html' class='scroll-link'><span class='glyphicon glyphicon-cog'></span>&nbsp;&nbsp;个人设置</a></li>" +
    ...
    "<li><a href='index2_8_1.html' class='scroll-link' id='MessageReminder'><span class='glyphicon glyphicon-envelope'></span>&nbsp;&nbsp;消息中心</a></li> " +
    ...
    "<li><a id='logout' class='scroll-link'><span class='glyphicon glyphicon-log-out'></span>&nbsp;&nbsp;注销</a> </li> " +
    "</ul>" +
    "</div> " +
    "</div> " +
    "</div>";
